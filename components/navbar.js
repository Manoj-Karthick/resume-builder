      ...
      <div className="relative flex items-center py-4">
        ...
        <div className="hidden lg:flex lg:items-center">
          ...
          <div className="hidden lg:ml-8 lg:pl-8 lg:flex lg:items-center lg:border-l lg:border-slate-300">
            <div className="inline-flex justify-center px-4 py-2.5 text-sm text-white font-semibold border bg-slate-950 rounded-lg hover:bg-slate-700 hover:cursor-pointer -my-2.5">
